...
const impactItems = [
  {
    title: "Lower sludge burden",
    text: "HydroTex targets a lower sludge burden than chemical-intensive coagulation and flocculation pathways.",
    icon: TrendingDown
  },
  {
      ...
      <div className="section-shell grid gap-9 lg:grid-cols-[0.92fr_1.08fr] lg:items-center">
        ...
        <div className="rounded-[8px] border border-hydro-line bg-hydro-paper p-5 shadow-soft">
          ...
          <div className="mt-4 rounded-[8px] bg-white p-4 text-sm leading-6 text-hydro-slate">
            <strong className="text-hydro-ink">AI-supervised control:</strong> A later
            digital layer is framed as PLC-compatible monitoring and
            optimization, not exaggerated black-box automation. It becomes
            relevant only after enough pilot data exists.
          </div>
        </div>
      </div>
    </Reveal>
    ...
    <Reveal id="founder" className="bg-white py-20 sm:py-24">
      <div className="section-shell grid gap-8 lg:grid-cols-[0.78fr_1.22fr] lg:items-center">
        ...
        <div>
          ...
          <h2 className="section-title">Technical depth with deliberately low early fixed costs.</h2>
          <p className="section-copy">
            HydroTex is structured as a gradual transition into a specialized
            commercial environmental technology and project-development service.
            The focus is customer discovery, real wastewater samples,
            feasibility evidence, and payable project work before larger pilot
            or plant decisions are made.
          </p>
        </div>
      </div>
    </Reveal>
